    ...
    return (
        ...
        <div className='fixed hidden peer-hover:flex ease-in lg:w-[100%] w-[100%] lg:h-[335px] hover:bg-white  bg-white   transition-all duration-700 hover:flex border top-0 absolute   shadow-md rounded-[10px]  z-50
         flex justify-center items-center'>
            <div className=" lg:w-[263px] m-auto transition-all duration-700 pt-7  text-center w-[344px] h-[335px] rounded-lg ">
                <img className='m-auto' src="https://res.cloudinary.com/egator-finance-ltd/image/upload/v1665787464/Sahara%20Practice/ArtificialInteligence_jqlt9f.png" alt="" />
